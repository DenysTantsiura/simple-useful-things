...
"""
У цьому прикладі ми пишемо в канали з батьківського процесу
sender1.send(8) та sender2.send(16), а читаємо з дочірніх
pipe.recv() всередині функції worker.
У канал можна відправити будь-який тип даних, який можна
перетворити на byte-рядок за допомогою pickle. Не можна
