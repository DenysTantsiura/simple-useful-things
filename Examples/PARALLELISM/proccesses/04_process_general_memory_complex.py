...
"""
Зверніть увагу, для опису полів структури їх треба помістити
в список кортежів _fields_, де кожен кортеж — це ім'я та тип поля.
Масив Array поводиться багато в чому як список і дозволяє зберігати
в ньому різнотипні дані, але його розмір статичний і додавати/видаляти
елементи не можна. Так само як і змінювати тип існуючих.

Також у структурі даних ми передали механізм блокування через
параметр lock. Як Value, так і Array забезпечують блокування ресурсу,
до якого можна отримати доступ, щоб як читати, так і оновлювати дані.
"""
